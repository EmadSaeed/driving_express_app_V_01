...
export function Header() {
  ...
  return (
    <header className={cn(
      ...
      <div className="flex h-16 items-center px-4 mx-auto md:max-w-7xl">
        ...
        <div className="flex items-center space-x-4 w-full pt-1">
          <Link href="/" className="flex items-center gap-2">
            <div className="relative w-[160px] h-[19px] md:w-[246px] md:h-[29px] dark:hidden">
              <Image
            ...
            <div className="relative w-[160px] h-[19px] md:w-[246px] md:h-[29px] hidden dark:block">
              <Image
        ...
        <div className="ml-auto flex items-center">
          <Button variant="ghost" size="sm" onClick={handleContactClick} className="border px-2 sm:px-3 sm:mr-6">
            Subscribe
          </Button>
          <ThemeToggle />
        </div>
