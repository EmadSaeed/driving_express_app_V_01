...
import MaterialSlider from '@/components/layout/MaterialSlider/MaterialSlider';
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-3        xl md:text-4xl lg:text-5xl">
                Welcome to Driving<span className='text-[#FF0000] pl-1'>Express</span>
              </h1>
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                Driving Made Simple, Know More, Drive Better!
              </p>
            </div>
