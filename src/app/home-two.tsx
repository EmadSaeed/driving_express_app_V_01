    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="py-12 md:py-16 lg:py-20">
        <NewsCard
          ...
          summary="Stock markets around the world saw significant gains today as economic indicators point towards a robust recovery from the recent downturn."
        />
      </section>
